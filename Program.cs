...
Console.WriteLine("Задача 4.Пользователь вводит число. Выведите на экран число, которое больше введенного\r\nна 10.");
...
Console.WriteLine("Задача 9. Известна стоимость 1 кг конфет, печенья и яблок. Найти стоимость всей покупки,\r\если купили x кг конфет, у кг печенья и z кг яблок.");
